...
const buttonVariants = cva(
  'inline-flex items-center transition-all duration-100 justify-center gap-2 whitespace-nowrap text-sm font-bold uppercase tracking-wide bk-interactive disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border-3 border-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
  {
    variants: {
      variant: {
        default:
